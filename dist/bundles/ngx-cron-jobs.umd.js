(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('rxjs/Subject'), require('rxjs/add/operator/takeUntil'), require('rxjs/add/operator/map'), require('rxjs/add/operator/publishReplay'), require('rxjs/add/operator/filter'), require('rxjs/add/operator/do')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', 'rxjs/Subject', 'rxjs/add/operator/takeUntil', 'rxjs/add/operator/map', 'rxjs/add/operator/publishReplay', 'rxjs/add/operator/filter', 'rxjs/add/operator/do'], factory) :
	(factory((global['ngx-cron-jobs'] = {}),global.ng.core,global.ng.common,global.ng.forms,global.Rx));
